...
define('ember-quickstart/tests/app.lint-test', [], function () {
  ...
  QUnit.test('routes/friends.js', function (assert) {
    assert.expect(1);
...
define('ember-quickstart/tests/tests.lint-test', [], function () {
  ...
  QUnit.test('unit/routes/friends-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/friends-test.js should pass ESLint\n\n');
  });
...
define('ember-quickstart/tests/unit/routes/friends-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
